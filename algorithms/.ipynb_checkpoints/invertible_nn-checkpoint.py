...
class ERM():
    ...
    def __init__(self, args, model, train_dataset, val_dataset):
        ...
        if self.latent_pred_task:
            self.save_path= 'results/' + 'num_tasks_' + str(self.args.num_tasks) + '_data_dim_' + str(self.args.data_dim) + '_latent_prediction_task.pth'
        else:
            self.save_path= 'results/' + 'num_tasks_' + str(self.args.num_tasks) + '_data_dim_' + str(self.args.data_dim) + '.pth'
